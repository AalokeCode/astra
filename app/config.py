...
class Config:
    ...
    live_audio_queue_chunks: int
    phone_public_url: str
    phone_stream_token: str
...
def load_config(env_file: Path | None = None) -> Config:
    ...
    data_dir = Path(_str("ASSISTANT_DATA_DIR", "~/.astra")).expanduser()
    ...
    return Config(
        ...
        live_audio_queue_chunks=max(4, _int("LIVE_AUDIO_QUEUE_CHUNKS", 500)),
        phone_public_url=_str("PHONE_PUBLIC_URL").rstrip("/"),
        phone_stream_token=_str("PHONE_STREAM_TOKEN"),
        data_dir=data_dir,
